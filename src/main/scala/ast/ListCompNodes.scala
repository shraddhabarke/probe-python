...
class StringToIntListCompNode(val list: ListNode[String], val map: PyIntNode, val varName: String) extends ListCompNode[Int]
class IntToStringListCompNode(val list: ListNode[Int], val map: PyStringNode, val varName: String) extends ListCompNode[String]
class IntToIntListCompNode(val list: ListNode[Int], val map: PyIntNode, val varName: String) extends ListCompNode[Int]